                ...
                <?php $__currentLoopData = $slide; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="swiper-slide">
                        <div class="box-banner">
                            <figure><img class="ofc" src="images/banner/<?php echo e($slide->banner); ?>.png" alt="" srcset="">
                                <figcaption>
                                    <div class="type-of-event">
                                        <h5><span>A . Event</span>| Thể loại sự kiện</h5><span><?php echo e($slide->loai_su_kien); ?></span>
                                    </div>
                                    <div class="name-event">
                                        <h5><?php echo e($slide->ten_s_kien); ?></h5>
                                    </div>
                                    <div class="decription-event">
                                        <p><?php echo e($slide->tom_tat); ?></p>
                                        <p><?php echo e($slide->thoi_gian); ?> - <?php echo e($slide->dia_diem); ?> (THỜI GIAN)</p>
                                    </div>
                                </figcaption>
                            </figure>
                        </div>
        ...
        <div class="container">
            <div class="catalog-wrapper">
                ...
                <div class="swpier-container slider-ProductByCatalog">
                    ...
                    <?php $__currentLoopData = $giaitri; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $giaitri): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="swiper-slide"><a href="#">
                                <figure>
                                    <div class="box-img">
                                    <img class="ofc" src="images/product/<?php echo e($giaitri->banner); ?>" alt="" srcset="">
                                    </div>
                                    <figcaption>
                                        <h3><?php echo e($giaitri->ten_su_kien); ?></h3>
                                        <div class="info-event">
                                            <div class="price">
                                                <h5>Giá:<span><?php echo e($giaitri->gia_ve); ?> VND</span></h5>
                                            </div>
                                            <div class="address">
                                                <h5>Địa chỉ:<span><?php echo e($giaitri->dia_chi); ?></span></h5>
                                            </div>
                                            <div class="time">
                                                <h5>Thời gian:<span><?php echo e($giaitri->ngay_dien_ra); ?></span></h5>
                                            </div>
                                        </div>
                                    </figcaption>
                                </figure></a>
    ...
    <section class="catalog-event bg-main">
        <div class="container">
            <div class="catalog-wrapper">
                ...
                <div class="swpier-container slider-ProductByCatalog">
                    <div class="swiper-wrapper">
                    <?php $__currentLoopData = $kienthuc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kienthuc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="swiper-slide"><a href="#">
                                <figure>
                                    <div class="box-img">
                                    <img class="ofc" src="images/product/<?php echo e($kienthuc->banner); ?>" alt="" srcset="">
                                    </div>
                                    <figcaption>
                                        <h3><?php echo e($kienthuc->ten_su_kien); ?></h3>
                                        <div class="info-event">
                                            <div class="price">
                                                <h5>Giá:<span><?php echo e($kienthuc->gia_ve); ?> VND</span></h5>
                                            </div>
                                            <div class="address">
                                                <h5>Địa chỉ:<span><?php echo e($kienthuc->dia_chi); ?></span></h5>
                                            </div>
                                            <div class="time">
                                                <h5>Thời gian:<span><?php echo e($kienthuc->ngay_dien_ra); ?></span></h5>
                                            </div>
                                        </div>
                                    </figcaption>
                                </figure></a>
            ...
            <div class="tab-container">
                ...
                <div class="tab-content">
                    <div class="content" tab-id="item-1">
                        <div class="list-news">
                            <?php $__currentLoopData = $new_01; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $new_01): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="item">
                                <figure>
                                    <div class="box-img">
                                    <img class="ofc" src="images/news/<?php echo e($new_01->hinh_anh_hien_thi); ?>" alt="" srcset=""></div>
                                    <figcaption>
                                        <h5><?php echo e($new_01->tieu_de); ?></h5><span class="time"><?php echo e($new_01->ngay_dang); ?></span>
                                        <p><?php echo e($new_01->tom_tat); ?>.</p>
                                    </figcaption>
                                </figure>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Event\A-Event\back-end\event\resources\views/pages/body.blade.php ENDPATH**/ ?>