	...
	private function save(){
		...
		if($this->id){
			...
			if(isset($_FILES['image']['tmp_name'])){
				$this->M_myweb->set_table('product_image_detail')->sets(array('deleted'=>1))->primary_key('product_id')->setPrimary($this->id)->save();
			...
			if(isset($data['img1'] ))
			{
				$this->M_myweb->set_table('product_image_detail')->sets(array('product_id'=>$id,'image_file'=>$data['img1'],'main'=>1))->setPrimary(false)->save();
			}
