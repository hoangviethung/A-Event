				...
				<div class="box-body">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div>
							<img id="imgFile_02" class="imgFile img-fluid" alt="Avatar" src="<?php echo base_url('assets/public/avatar/no-avatar.png'); ?>" style="max-width:300px" />
							<div class="img_input">
							</div>
							<input type="file" class="chooseImgFile" name="image[]" multiple="multiple" onchange="uploadMultiple(this.files)" style="max-width:300px;">
							<script>
								function uploadMultiple(files) {
									var i;
									for (i = 0; i < files.length; i++) {
										var fileUrl = window.URL.createObjectURL(files[i]);
										var file = '<img class="imgFile img-fluid" alt="Avatar" src="' + fileUrl + '" style="max-width:300px;margin-right:10px;margin-top:10px;border:1px solid black;"/>'
