										...
										<?php if ($obj->level == 0) { ?>
											...
											<td class='p-t-20'>
												<div class="category-item-wrap"style="padding:0 0px 0px 15px">
													<div class='text-right'><a href="<?php echo site_url('admin/category?act=child_list&id=' . $obj->id . "&token=" . $infoLog->token); ?>"><span class='pull-left' style="line-height:34px;font-weight:700"><?php echo $obj->name ?></span></a>
												...
												<ul style="list-style:none;margin:20px 0px 20px 20px;">
													<?php foreach ($category as $key => $child_1) { ?>
														<?php if ($child_1->parent_1 == $obj->id && $child_1->level == 1) { ?>
															<li class="text-right">
																<div class="category-item-wrap" style="padding:0 0px 0px 15px">
																<a href="<?php echo site_url('admin/category?act=child_list&id=' . $child_1->id . "&token=" . $infoLog->token); ?>" class='pull-left text-dark' style="line-height:34px;font-weight:600">
																...
																<ul style="list-style:none;margin:20px 0px 20px 20px;">
																	...
																	<?php foreach ($category as $key => $child_2) { ?>
																		<?php if ($child_2->parent_2 == $child_1->id) { ?>
																			...
																			<a href="<?php echo site_url('admin/category?act=child_list&id=' . $child_2->id . "&token=" . $infoLog->token); ?>" class='pull-left text-dark' style="line-height:34px;font-weight:500"> - - <?php echo $child_2->name; ?></a>
